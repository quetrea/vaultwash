      ...
      children: [
        AppSectionHeader(
          ...
          subtitle: files.isEmpty
              ? 'Files with broken citation artifacts will appear here after a scan.'
        ...
        Expanded(
          child: files.isEmpty
              ? const EmptyStateView(
                  ...
                  title: 'No cleanup needed in this scan',
                  message:
                      'VaultWash did not find broken citation artifacts in the markdown files that were inspected.',
